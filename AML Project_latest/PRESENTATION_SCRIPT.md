...
│ [ Customer ID | Name | Branch | Risk Score | Triage Priority | Remarks | AML Action ]                     │
│ • CUS-1013 | Rajesh Singhania | Metro Branch | 🚨 100 (High) | 🔴 High Priority (Review for STR) | 🔍 Investigate │
│ • CUS-1005 | Sonia Kapoor     | West End     | 🌿  18 (Low)  | 🟢 Routine (Low Priority)         | 🔍 Investigate │
├────────────────────────────────────────────────────────────────────────────────────────────────────────┤
...
3. **Monitored Customer Directory Table (`gr.Dataframe`):**
   ...
   * **Triage Priority:** Fast 3-tier pre-investigation priority (`🔴 High Priority (Review for STR)`, `🟡 Review Required (Medium Priority)`, `🟢 Routine (Low Priority)`).
   * **Remarks:** Compliance audit trail with automated AI adjudication logging (e.g. `✅ AI Closed: False Positive...`) and manual inline editing.
