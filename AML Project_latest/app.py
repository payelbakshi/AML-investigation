    ...
    try:
        ...
        if is_auth_error:
            message = (
                ...
                "Please set a valid GEMINI_API_KEY (starts with AIzaSy...) or OPENAI_API_KEY (starts with sk-...) in your environment."
            )
        elif is_quota_error:
            message = (
                "API quota exhausted. Check your Gemini/OpenAI account quota, then retry."
            )
        else:
