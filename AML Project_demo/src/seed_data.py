...
CUSTOMER_SEED = [
    ...
    },
    {
        ...
        "kyc": {
            ...
            "nationality": "IN",
            "past_investigations": ["Cleared on domestic salary & grocery alert - December 2025 (Precedent Applies: Benign routine activity)"],
        },
        "transactions": [
    ...
    },
    {
        ...
        "kyc": {
            ...
            "nationality": "IN",
            "past_investigations": ["Cleared on low-volume domestic invoice alert 3 months ago (Pattern changed: now exhibits large cross-border SWIFT transactions with Dubai/Hong Kong)"],
        },
        "transactions": [
    ...
    {
        "customer_id": "CUS-1013",
        "name": "Rajesh Singhania",
        "branch": "Metro Commercial Branch",
        "remarks": "Frequent sub-threshold cash deposits across branches",
        "kyc": {
            "occupation": "Real Estate Broker",
            "declared_monthly_income": 4000,
            "account_age_months": 10,
            "account_purpose": "Personal & Brokerage Operations",
            "nationality": "IN",
            "past_investigations": [],
        },
        "transactions": [
            ("2026-03-01 09:30", "Cash deposit branch counter", 9400, "Cash Deposit", "Self"),
            ("2026-03-01 14:15", "Cash deposit ATM kiosk", 9650, "Cash Deposit", "Self"),
            ("2026-03-02 10:00", "Cash deposit branch counter", 9800, "Cash Deposit", "Self"),
            ("2026-03-02 16:45", "Cash deposit ATM kiosk", 9500, "Cash Deposit", "Self"),
            ("2026-03-03 11:20", "Cash deposit CDM terminal", 9750, "Cash Deposit", "Self"),
            ("2026-03-04 09:00", "International outward investment wire", -47500, "SWIFT", "Panama Holding Corp"),
        ],
    },
    {
        "customer_id": "CUS-1014",
        "name": "Tariq Mansoor",
        "branch": "Tech Park Branch",
        "remarks": "Rapid pass-through with multiple corporate senders",
        "kyc": {
            "occupation": "IT Consultant",
            "declared_monthly_income": 3500,
            "account_age_months": 5,
            "account_purpose": "Consulting Retainers",
            "nationality": "IN",
            "past_investigations": [],
        },
        "transactions": [
            ("2026-03-01 10:15", "Consulting advance payment", 14500, "Wire Transfer", "Nexus Corp"),
            ("2026-03-01 13:40", "Technical service fee", 16800, "Wire Transfer", "Vortex Media LLC"),
            ("2026-03-02 09:30", "Software development milestone", 18200, "Wire Transfer", "Starlight Holdings"),
            ("2026-03-02 15:00", "Advisory service retainer", 12500, "Wire Transfer", "Zenith Global"),
            ("2026-03-03 08:45", "Offshore consultancy settlement", -61000, "SWIFT", "Apex Horizon Shell Ltd BVI"),
        ],
    },
    {
        "customer_id": "CUS-1015",
        "name": "Deepa Malhotra",
        "branch": "West End Branch",
        "remarks": "Dormant account surge with crypto & offshore liquidation",
        "kyc": {
            "occupation": "Graphic Designer",
            "declared_monthly_income": 2800,
            "account_age_months": 36,
            "account_purpose": "Personal Savings & Freelance",
            "nationality": "IN",
            "past_investigations": [],
        },
        "transactions": [
            ("2026-02-15 10:00", "Monthly design retainer salary", 2800, "Credit", "Design Studio Co"),
            ("2026-02-28 14:20", "Grocery & household utility debit", -180, "POS", "Retail Mart"),
            ("2026-03-02 09:15", "Sudden foreign commercial remittance", 48000, "SWIFT", "Al-Zahra Trading LLC Dubai"),
            ("2026-03-02 11:30", "Instant crypto digital asset purchase", -25000, "Wire Transfer", "Binance Crypto Gateway"),
            ("2026-03-02 14:00", "Escrow deposit offshore entity", -22000, "SWIFT", "Cayman Island Trust Ltd"),
            ("2026-03-03 18:10", "Coffee shop debit", -15, "POS", "Cafe Bistro"),
        ],
    },
]
